...
const KeywordExplorer = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #020617 0%, #0f172a 100%)', color: '#f8fafc', fontFamily: 'Inter, sans-serif' }}>
      ...
      <main className="keyword-main" style={{ padding: '160px 24px 100px', position: 'relative' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 10 }}>
          ...
          <div style={{ background: 'rgba(15,23,42,0.7)', backdropFilter: 'blur(40px)', padding: '40px', borderRadius: '40px', border: '1px solid rgba(255,255,255,0.06)', boxShadow: '0 40px 100px rgba(0,0,0,0.5)', marginBottom: '50px' }} className="keyword-search-container">
             <form onSubmit={handleSearch} className="keyword-search-form" style={{ display: 'grid', gridTemplateColumns: '1fr 0.6fr 0.6fr auto', gap: '20px', alignItems: 'center' }}>
               <div style={{ position: 'relative' }}>
                 <span style={{ position: 'absolute', left: '20px', top: '50%', transform: 'translateY(-50%)', opacity: 0.4 }} dangerouslySetInnerHTML={{ __html: '&#128269;' }}></span>
          ...
          <AnimatePresence>
            {results && (
              <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} style={{ background: 'rgba(15,23,42,0.3)', borderRadius: '40px', border: '1px solid rgba(255,255,255,0.04)', padding: '50px', marginBottom: '80px' }} className="results-container">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '40px', borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '30px' }} className="report-header">
                  ...
                  <div style={{ display: 'flex', gap: '12px' }} className="report-actions">
                ...
                <div style={{ display: 'flex', gap: '12px', marginBottom: '40px', flexWrap: 'wrap', background: 'rgba(255,255,255,0.03)', padding: '15px', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.08)', backdropFilter: 'blur(10px)' }} className="tab-container">
          ...
          <section style={{ marginTop: '80px', display: 'flex', flexDirection: 'column', gap: '50px' }} className="keyword-guide-section">
            <div style={{ background: 'rgba(15,23,42,0.4)', padding: '60px', borderRadius: '40px', border: '1px solid rgba(255,255,255,0.06)' }} className="guide-box">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px' }} className="keyword-guide-grid">
               <div style={{ background: 'rgba(15,23,42,0.4)', padding: '50px', borderRadius: '40px', border: '1px solid rgba(255,255,255,0.06)' }} className="guide-box">
          ...
          {/* FAQ SECTION */}
          <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '40px', marginTop: '80px' }} className="keyword-faq-grid">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '25px' }}>
               <div style={{ background: 'rgba(59,130,246,0.05)', padding: '40px', borderRadius: '40px', border: '1px solid rgba(59,130,246,0.1)' }} className="guide-box">
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          .keyword-main { padding: 100px 15px 100px !important; }
          .keyword-search-form { grid-template-columns: 1fr !important; gap: 10px !important; }
          .keyword-search-container { padding: 25px !important; border-radius: 25px !important; }
          .keyword-guide-grid, .keyword-faq-grid { grid-template-columns: 1fr !important; gap: 20px !important; }
          .guide-box { padding: 30px !important; border-radius: 25px !important; }
          .results-container { padding: 25px !important; border-radius: 25px !important; }
          .report-header { flex-direction: column !important; align-items: flex-start !important; gap: 20px !important; }
          .report-actions { width: 100% !important; flex-direction: column !important; }
          .report-actions button { width: 100% !important; }
