...
const Footer = () => {
  ...
  return (
    <footer className="landing-footer" style={{ 
      ...
      <div className="footer-main" style={{ padding: '30px 24px 40px', position: 'relative' }}>
         ...
         <div className="footer-container" style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr 1.5fr', gap: '60px' }}>
            ...
            <div className="footer-section">
               ...
               <p style={{ color: '#64748b', fontSize: '14px', lineHeight: '1.8', marginBottom: '30px' }}>
            ...
            <div className="footer-section">
               ...
               <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '18px' }}>
                  <li><Link to="/keywords" className="footer-link">Keyword Research</Link></li>
