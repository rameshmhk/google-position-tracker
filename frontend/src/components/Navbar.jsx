  ...
  return (
    <>
        ...
        <div className="navbar-container">
          ...
          <div className="nav-menu-wrapper">
            <ul className="nav-menu">
              ...
              <li><Link to="/keywords" style={{ color: '#cbd5e1' }}>Keywords</Link></li>
              ...
              {user ? (
                ...
                <li className="nav-dropdown-item" style={{ position: 'relative' }}>
                  <button className="nav-btn" style={{ background: 'var(--accent)', color: '#fff', border: 'none', borderRadius: '4px', fontWeight: '800', cursor: 'pointer', padding: '10px 20px' }}>
                    Get Started ▾
                  </button>
      ...
      <div className="mobile-bottom-nav">
        ...
        <Link to="/whois" className={`mobile-nav-link ${location.pathname === '/whois' ? 'active' : ''}`}>
          <span className="mobile-nav-icon">🏢</span>
          <span>Whois</span>
        </Link>
        <Link to={user ? "/dashboard" : "/login"} className={`mobile-nav-link ${location.pathname === '/dashboard' || location.pathname === '/login' ? 'active' : ''}`}>
          <span className="mobile-nav-icon">👤</span>
